...
//    }
    public WangContextRecyclerViewAdapter(Context mcontext, ArrayList<WangContext> list_context){
        mlayoutInflater=LayoutInflater.from(mcontext);
        this.mcontext=mcontext;
        this.list_context=list_context;
        myUpload=new MyUpload(mcontext);
...
//        if(getItemViewType(position) == NORMAL_TYPE) {
            ...
            myUpload.download_asynchronous_head("wangweibodata", "headimg/" +list_context.get(position).getWritename(),wuViewHolder.img_head);
