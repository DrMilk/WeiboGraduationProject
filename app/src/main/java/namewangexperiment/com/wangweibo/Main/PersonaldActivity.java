...
import namewangexperiment.com.wangweibo.Utils.BitmapUtil;
...
public class PersonaldActivity extends Activity implements View.OnClickListener {
    ...
    private void initview() {
        ...
        ed_sign = (EditText) findViewById(R.id.personal_sign);
    ...
    protected void onResume() {
        if (checkuser()) {
            ...
            if(xuuser.isImgheadstutas()){
                myUpload.download_asynchronous("wangweibodata", "headimg/" + xuuser.getUsername(),img_head);
            }
        }
        super.onResume();
    }
    ...
    private boolean checkuser() {
        ...
        if (bmobUser != null) {
            ...
            imgheadstutus=xuuser.isImgheadstutas();
            sign=xuuser.getSign();
