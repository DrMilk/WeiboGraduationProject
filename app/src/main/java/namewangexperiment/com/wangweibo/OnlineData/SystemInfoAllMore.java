...
public class SystemInfoAllMore extends BmobObject {
    private ArrayList<String> search_more_list;
    private ArrayList<String> banner_pic_list;
    public SystemInfoAllMore(){}
    public SystemInfoAllMore(ArrayList<String> search_more_list, ArrayList<String> banner_pic_list) {
